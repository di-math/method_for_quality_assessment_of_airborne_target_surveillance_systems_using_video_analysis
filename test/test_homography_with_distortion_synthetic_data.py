...
"""
This code can be used to generate a test image (just dots) on a defines image size, distort this image using distortion parameters,
then apply the find_homography_with_distortion function, to then again undistort the image with the computed distortion parameters.
"""
